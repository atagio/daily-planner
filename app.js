...
const quotes = [
    ...
    "Bیا که قصر امل سخت سست بنیاد است / به باده فکر بنا کن که برقرار بوَد. (حافظ)",
...
// اجرای اولیه تابع برای اینکه پِیج خالی یا با متن پیش‌فرض باز نشود
getRandomQuote();
...
if ('serviceWorker' in navigator) {
    window.addEventListener('load', () => {
        navigator.serviceWorker.register('service-worker.js')
            .then(registration => {
                console.log('ServiceWorker با موفقیت ثبت شد با اسکوپ: ', registration.scope);
            })
            .catch(error => {
                console.error('ثبت ServiceWorker با خطا مواجه شد: ', error);
            });
    });
}
